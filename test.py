...
from utils.utilities import crop_img, numpyIMG_resize, cc_map_postprocessing, min_max_norm
...
model = U_Net()
test_dataset = get_input_data(15, 20, file_path = "/Users/iptvpeullaespomgaebaltim/Desktop/python_codes/subscription_finder/datasets/ScaryMovie4.mp4")
