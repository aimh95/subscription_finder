...
class ReadVideoAsData(tf.keras.utils.Sequence):
    def __init__(self, dataset_path, output_path, model_weight_path, model, padding = 0):
    ...
    def _run(self, start_time=None, end_time=None, frame=None):
        ...
        while success:
            ...
            if start_time == None and end_time == None:
                ...
                # self._plot_on_screen(mapping_result, "mapping_result")
                # self._plot_on_screen(mapping_result_on_frame/255., "mapping_result_on_frame")
    ...
    def _subtitle_prob_burn_in(self, image, subtitle_prob):
        ...
        draw.text((10, 10), str(subtitle_prob), fill="red", font=font)
