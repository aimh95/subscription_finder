...
from models.real_u_net_light import U_Net
...
weight_save_path = "weight_path/real_u_net_light_totaltext_1000epochs_load"
...
if data_version == 0:
    ...
    model.fit(data_loader, initial_epoch=initial_epoch, batch_size = 32, epochs=1000, callbacks=[tensorboard_callback, cb, cp_callback])
